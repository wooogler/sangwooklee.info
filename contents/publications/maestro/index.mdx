...
author: "Sangwook Lee, Adnan Abbas, Sang Won Lee, Young-Ho Kim, Yan Chen"
publication_url: "https://doi.org/10.1145/3830398.3830672"
publication_date: "2026-11-02"
conference: "ACM UIST 2026"
thumbnail: "./MAESTRO_thumbnail.png"
paper_pdf: "./uist26a-sub7009-cam-i32.pdf"
github_url: "https://github.com/wooogler/maestro-movie"
demo_url: "https://maestro.cs.vt.edu/"
format: "paper"
highlighted: true
slug: "maestro"
---
...
MAESTRO extends a Conversational Agent with GUI (CAG) by introducing a *shared preference memory* — which records preferences as *hard* (obligatory) or *soft* (hedged) — and two grounded mechanisms:
...
We evaluated MAESTRO through a 2×2 within-subjects study (N=33) using a movie-ticketing CAG, crossing Condition (Baseline vs. MAESTRO) with Mode (Text vs. Voice). Each participant completed four rounds — one per condition — each pairing a warm-up task with a main task that required revisiting earlier steps due to preference conflicts. We analyzed the resulting 132 main-task trials with mixed-effects models, with results shown below.
